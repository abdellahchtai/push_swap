...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/22 16:38:00 by abchtaib          #+#    #+#             */
/*   Updated: 2025/12/31 15:49:06 by abchtaib         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av)
{
	...
	if (list_sorted(stacka))
		return (ft_lstclear(&stacka), 0);
	ft_sort(&stacka, &stackb, size);
	ft_lstclear(&stacka);
	ft_lstclear(&stackb);
	return (0);
}
